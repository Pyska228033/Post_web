...
$SQLstring = "UPDATE message SET recipient = '$recipient',senders_post_office = '$sender_postoffice',recipients_post_office = '$recipient_postoffice', type_of_message = '$idtypeofmessage', status = '$status', date_of_dispatch = '$date_of_dispatch', date_of_receipt = '$date_of_receipt', Comment = '$comment' WHERE idMessage = $idMessage";
$result5 = mysqli_query($dblink, $SQLstring);

// Проверяем, есть ли ошибки
if ($result5 == 'TRUE') {
    include("UpdateAndSave.php");
